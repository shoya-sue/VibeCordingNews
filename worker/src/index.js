...
// opening(12)×mood(10)×subject(10)×state(10)×nuance(8)×suffix(8)×emoji(12)×retry(10)×tail(8)
// = 12×10×10×10×8×8×12×10×8 = 921,600,000通り
const _ERR_API = {
  opening:  ["うぅ…", "あのね、", "ご、ごめんね！", "えっとね…", "むむ…", "わわっ、",
             "ちょっと待って、", "ご、ごめん！", "（うわぁ、タイミング悪っ！）", "あれ〜？", "えっ…", "ぽかん…"],
  mood:     ["", "（ちょっと焦ってる）", "（ごめんなさい…）", "（困り気味）", "（どうしよ…）",
             "（なんとかしたいんだけど）", "（これは辛い…）", "（ほんとごめんね）", "（胃が痛い）", "（反省中）"],
  subject:  ["Geminiが", "AIが", "Geminiさんが", "頭の中が", "こっちの回線が",
             "思考エンジンが", "バックエンドが", "サーバー側が", "AIの脳が", "処理系が"],
  state:    ["ちょっとお疲れ", "混んでる", "パンク中", "バタバタ", "お休み中",
             "ぐったりしてる", "返事してくれない", "さぼり気味", "過負荷っぽい", "ダウン気味"],
  nuance:   ["", "みたいで…", "っぽくて…", "みたい！", "で…", "かも…", "感じ…", "そうで…"],
  suffix:   ["ちょっと待ってね", "少し時間をちょうだい", "もう少しだけ待って", "許してね",
             "ごめんね", "なんとかするから", "焦らないでね", "ちょっとだけ余裕をくれると嬉しいな"],
  emoji:    ["😢", "💦", "😵‍💫", "🥺", "💤", "🔇", "😅", "⏳", "😭", "💨", "🤔", "🫠"],
  retry:    ["しばらくしてからまた聞いてね！", "少し待ってからまた話しかけてくれる？",
             "もう少し待ってみて！", "時間おいてもう一度試してみてほしいな！",
             "また呼んでね〜！", "再試行してみてもらえる？", "しばらく経ったらまたきてね！",
             "少ししたら復活するはず！", "ちょっと待ってからまた来てね！", "もう一回あとで試してみて！"],
  tail:     ["", " ごめんね！", " すぐ戻るよ！", " 待っててね！",
             " また話しかけてね！", " 絶対直るから！", " 心配しないでね！", " 頑張るよ！"],
};

// ネットワーク接続自体が失敗した場合
// opening(12)×mood(10)×subject(10)×state(10)×bridge(8)×emoji(8)×retry(10)×tail(8)
// = 12×10×10×10×8×8×10×8 = 614,400,000通り
const _ERR_NETWORK = {
  opening:  ["あれ、", "うーん、", "ちょっと待って！", "えっ！？", "ご、ごめんよ〜！",
             "（あ、これ通信エラーだ…）", "むっ…", "あわわっ！", "えーっと、", "ぎゃー！", "うわわ、", "はわわっ、"],
  mood:     ["", "（焦ってる…）", "（ちょっと困ってる）", "（どうしよ…）", "（ごめんなさい！）",
             "（悔しい！）", "（あわわ）", "（反省…）", "（なんとかしたいよ〜）", "（これは辛い）"],
  subject:  ["ネットワークが", "電波が", "接続が", "信号が", "通信が",
             "回線が", "インターネットが", "データの経路が", "パケットが", "サーバーへの道が"],
  state:    ["おかしくなっちゃった？", "届かなかったみたいで", "切れちゃったみたい…",
             "ロストしちゃったの", "弱いのかな", "うまくいかなかった",
             "つながらなかった", "タイムアウトしちゃった", "応答がなかった", "迷子になっちゃった"],
  bridge:   ["", " あ〜、", " えっと、", " ごめんなさい、", " びっくりしたけど", " 焦ったよ！", " ちょっと困った…", " 残念だけど"],
  emoji:    ["📡", "💔", "😱", "😤", "🕳️", "🌐", "📶", "💀"],
  retry:    ["もう一度試してみて！", "また話しかけてね！", "再試行してみてね！",
             "もう一回だけ試してくれる？", "また呼んでね！", "もう一度やってみて！",
             "しばらくしてから試してみて！", "時間おいてもう一回来てね！",
             "もう少ししたらまた呼んでね！", "ちょっと待ってからまた来てね！"],
  tail:     ["", " ごめんね！", " すぐ直ると思う！", " 待っててね！",
             " また来てね！", " 絶対またつながるよ！", " 諦めないでね！", " 頑張るよ！"],
};

// Gemini が空のレスポンスを返した場合
// opening(10)×mood(10)×state(10)×reaction(8)×bridge(8)×emoji(8)×retry(10)×tail(10)
// = 10×10×10×8×8×8×10×10 = 512,000,000通り
const _ERR_EMPTY = {
  opening:  ["あれれ…", "うーん、", "えっ…", "ぽかん…", "あっ、", "ん〜、",
             "（なんも出てこない！どうしよ！）", "むむ…", "あわわ…", "ぎゃー！"],
  mood:     ["", "（困ってる…）", "（頭が真っ白だよ！）", "（焦った！）", "（ごめんなさい）",
             "（どうしよ…）", "（反省中）", "（うぅ…）", "（悔しい！）", "（なんとかしたいのに）"],
  state:    ["言葉が出てこなかったの", "頭が真っ白になっちゃって…", "なんも浮かんでこなかった！？",
             "頭の中が空っぽに", "言葉がフリーズしちゃった", "思考がショートしちゃったっぽい",
             "ブレインがクラッシュしちゃった", "アイデアが出てこなかったの",
             "うまく言葉にできなかったの", "レスポンスが空だったの"],
  reaction: ["", " （空振り！）", " （え、マジで…）", " （ショック…）",
             " （あわわ）", " （うぅ…）", " （頑張ったのに）", " （なんでだろ）"],
  bridge:   ["", " えっと…", " でもね、", " ごめんね、", " ほんとにごめんなさい、",
             " なんとかしたかったんだけど、", " 信じてほしいんだけど、", " 絶対次は答えるから、"],
  emoji:    ["🤯", "💭", "😶", "🫥", "🧊", "⚡", "😵", "🌀"],
  retry:    ["もう一度聞いてくれる？", "もう一回聞いてもらえる？", "もう一度お願い！",
             "再度聞いてみてくれると助かる！", "気を取り直してもう一回！",
             "もう一回だけ試してみて！", "また聞いてね！", "もう一度チャレンジしてみて！",
             "再トライしてくれると嬉しいな！", "また話しかけてね！"],
  tail:     [" 今度はちゃんと答えるから！", " きっと今度は大丈夫！", " ごめんね！", "",
             " 次こそ！", " 絶対答えるから！", " 期待してて！", " 全力でいくよ！",
             " 頑張るね！", " またチャレンジするよ！"],
};

// コマンドハンドラ全体でエラーが発生した場合
// opening(12)×mood(10)×state(10)×reaction(8)×bridge(10)×emoji(10)×retry(10)×tail(8)
// = 12×10×10×8×10×10×10×8 = 768,000,000通り
const _ERR_HANDLER = {
  opening:  ["あわわっ！", "ぎゃーっ！", "え、えっと…", "うわあ、", "（やばい、エラーだ！）",
             "ちょ、ちょっと待って！", "む、むむ…", "あっ！", "えーっ！", "ひゃー！", "うわわわ！", "はわわっ！"],
  mood:     ["", "（ほんとごめんなさい）", "（どうしよ…）", "（あわわ）", "（反省してる）",
             "（悔しい！）", "（なんとかしなきゃ！）", "（焦ってる！）", "（ショック…）", "（原因調査中）"],
  state:    ["なんか変なことが起きちゃった！", "エラーが出ちゃった！", "なんかバグっちゃったみたい",
             "なんか壊れちゃった感じがする！", "うまく動かなかった…",
             "なんか予期しないことが起きて…", "これは想定外だった", "なんかぐちゃぐちゃになっちゃった！",
             "動作がおかしくなっちゃったの", "予期せぬエラーが起きちゃった"],
  reaction: ["", " （ぎゃー！）", " （うわ！）", " （どうしよ！？）",
             " （緊急事態！）", " （あわわ！）", " （ショック…）", " （現実逃避したい）"],
  bridge:   ["", " でもね、", " えっとね、", " ごめんなさいなんだけど、", " 正直に言うと、",
             " 困ったことに、", " 申し訳ないんだけど、", " どうやら、", " 恥ずかしながら、", " 残念ながら、"],
  emoji:    ["😱", "😭", "🐛", "💥", "😰", "💦", "🌀", "😲", "🫨", "🤯"],
  retry:    ["もう一度試してみてね！", "再試行してみてね！", "もう一回やってみてくれる？",
             "もう一度だけ試してみて！", "また呼んでね！", "もう一度お願いできる？",
             "しばらくしてからまた話しかけてね！", "ちょっと待ってからまた来てね！",
             "もう一回だけチャレンジしてみて！", "また話しかけてくれると嬉しいな！"],
  tail:     ["", " ごめんね！", " すぐ直すよ！", " 待っててね！",
             " また来てね！", " 全力で復旧するよ！", " 頑張るよ！", " 諦めないでね！"],
};
...
function pickError(type) {
  if (type === "api") {
    return _r(_ERR_API.opening) + _r(_ERR_API.mood) + _r(_ERR_API.subject)
         + _r(_ERR_API.state) + _r(_ERR_API.nuance) + _r(_ERR_API.suffix)
         + _r(_ERR_API.emoji) + " " + _r(_ERR_API.retry) + _r(_ERR_API.tail);
  }
  if (type === "network") {
    return _r(_ERR_NETWORK.opening) + _r(_ERR_NETWORK.mood) + _r(_ERR_NETWORK.subject)
         + _r(_ERR_NETWORK.state) + _r(_ERR_NETWORK.bridge)
         + _r(_ERR_NETWORK.emoji) + " " + _r(_ERR_NETWORK.retry) + _r(_ERR_NETWORK.tail);
  }
  if (type === "empty") {
    return _r(_ERR_EMPTY.opening) + _r(_ERR_EMPTY.mood) + _r(_ERR_EMPTY.state)
         + _r(_ERR_EMPTY.reaction) + _r(_ERR_EMPTY.bridge)
         + _r(_ERR_EMPTY.emoji) + " " + _r(_ERR_EMPTY.retry) + _r(_ERR_EMPTY.tail);
  }
  // handler
  return _r(_ERR_HANDLER.opening) + _r(_ERR_HANDLER.mood) + _r(_ERR_HANDLER.state)
       + _r(_ERR_HANDLER.reaction) + _r(_ERR_HANDLER.bridge)
       + _r(_ERR_HANDLER.emoji) + " " + _r(_ERR_HANDLER.retry) + _r(_ERR_HANDLER.tail);
}

// ─── コマンド応答メッセージパターン ───

// /news ニュース未取得
// opening(15)×mood(10)×reaction(10)×nuance(10)×body(12)×connector(8)×emoji(8)×tail(10)
// = 15×10×10×10×12×8×8×10 = 115,200,000通り
const _MSG_NO_NEWS = {
  opening:   ["ん〜、", "あれれ、", "うーん…", "ちょっと待って、", "えっと、", "むむ…", "あっ、",
              "（なかったよ…）", "ぬぅ…", "やばっ、", "あ〜あ、", "うぅ、", "ちょーん…", "えーっ、", "（悲報）"],
  mood:      ["", "（内心がっかり）", "（しょんぼり）", "（ちょっと焦り気味）", "（本当に探したの！）",
              "（毎回ちゃんと探してるんだけどな）", "（これは悔しい）", "（空振りは辛い）",
              "（諦めたくないけど）", "（でも嘘はつけないの）"],
  reaction:  ["", " （空振り！）", " （どこ行ったの！？）", " （え、マジで…）", " （うぅ…）",
              " （全力で探したのに）", " （あわわ）", " （ごめんなさい）", " （ショック…）", " （現実逃避したい）"],
  nuance:    ["", "実は", "正直、", "残念ながら、", "悲しいことに、", "まさかの、",
              "信じたくないけど、", "どうやら", "困ったことに、", "なんと"],
  body:      ["今はニュースが取得できなかったの", "まだニュースが届いてないみたい", "ニュースが見つからなかったの",
              "今回はニュースが取れなかったよ", "ちょっと空振りしちゃったかも", "配信データが見当たらなかったの",
              "RSSが空っぽだったみたい", "何も引っかからなかったの…", "データが来てなかったの",
              "記事がまだ更新されてないみたい", "フィードが空だったよ", "今は何もなかったの"],
  connector: ["。", "…。", "みたい。", "みたいなの。", "だって。", "らしいよ。", "なんだよね。", "っぽい。"],
  emoji:     ["📭", "🙈", "😅", "🔍", "📡", "🌀", "😶", "💨"],
  tail:      ["定時配信をお楽しみに！", "しばらく待ってみてね！", "次の配信を待っててね！",
              "もう少し後で確認してみて！", "すぐまた来るよ！", "引き続きよろしくね！",
              "次は絶対ちゃんと持ってくるから！", "しばらくしたら更新されるはず！",
              "また後で試してみてね！", "楽しみにしていてね！"],
};

// /news 成功時冒頭
// opening(15)×mood(10)×vibe(10)×energy(12)×body(12)×hype(8)×exclaim(8)
// = 15×10×10×12×12×8×8 = 138,240,000通り
const _MSG_NEWS_INTRO = {
  opening:  ["はいはい〜！", "さっそく！", "待ってた！？", "わあ、来たよ〜！", "どうぞ〜！",
             "お届けします！", "はーい！", "きたきた〜！", "あったよ〜！", "ばばーん！",
             "いぇーい！", "ふふ〜！", "じゃじゃーん！", "ほーい！", "うおー！"],
  mood:     ["", " （うれし〜！）", " （わくわく〜！）", " （どやっ！）", " （探してきたよ！）",
             " （全力で集めたよ！）", " （ピカピカ新鮮！）", " （今日もバッチリ！）", " （愛を込めて！）", " （えいっ！）"],
  vibe:     ["", " Vibeちゃんからの", " 今日の", " 熱々の", " 厳選した", " お待たせ！",
             " こだわりの", " Vibe高めの", " 全力で集めた", " ほかほかの"],
  energy:   ["最新ニュースをお届けするよ！", "今日のVibeCordingニュースだよ！", "新鮮ほかほかのニュースだよ！",
             "チェックしてみてね！", "選りすぐりのニュースだよ！", "気になる記事を持ってきたよ！",
             "今日の収穫はこちら！", "ピックアップしてきたよ！", "特選ニュースをどうぞ！",
             "今日もVibe高めの記事があったよ！", "熱いニュースを持ってきたよ！", "お宝記事を発掘したよ！"],
  body:     ["読んでみてね！", "チェックしてみて！", "ぜひ見てみてね！", "どうぞ〜！",
             "気になるの見つかったかな？", "いかがかな？", "楽しんでね！", "役立てたら嬉しいな！",
             "一緒にVibeっていこー！", "今日も素敵なVibe！", "VibeCodingライフに役立ててね！", "感想も聞かせてね！"],
  hype:     ["", " 📰", " ✨", " 🎉", " 🔥", " ⚡", " 💫", " 🚀"],
  exclaim:  ["", "！", " ✨✨", " 🎊", " 🎶", " 🌟", " 🎯", " 💥"],
};

// /news 成功時末尾
// prefix(8)×mood(10)×body(20)×bridge(10)×suffix(12)×tone(10)×emoji(10)
// = 8×10×20×10×12×10×10 = 192,000,000通り (inside _..._)
const _MSG_NEWS_TAIL = {
  prefix:  ["", "ちなみに、", "そういえば、", "最後に、", "おまけ：", "P.S. ", "ひとこと：", "〆に、"],
  mood:    ["", "ふふ、", "えへ、", "うふ、", "わーい！", "なんか、", "実は、", "ところで、", "ね、", "じつは"],
  body:    ["気になる記事があったら読んでみてね", "面白そうなの見つかった？", "ぜひチェックしてみて",
            "VibeCodingライフを楽しんでね", "役に立てたら嬉しいな", "今日もコーディング楽しんでね",
            "一緒にVibeっていこー", "また気になったら呼んでね", "毎日チェックしてね",
            "お気に入りを見つけてね", "参考になるの見つかったかな", "楽しんでもらえたら嬉しいな",
            "今日のVibeCoding、どうだった？", "読み応えあったかな？", "また持ってくるね",
            "次も良い記事持ってくるね", "これからも一緒にVibeっていこうね", "気に入った記事はシェアしてね",
            "一歩ずつ成長していこうね", "もっと気になったら/askで聞いてね"],
  bridge:  ["", " でも", " だから", " だって", " とはいえ", " まぁ", " だよね", " ね〜", " よ〜", " かな"],
  suffix:  ["！", "！✨", "！📰", "〜！", "ね！", "よ！", "かな？", "！🎉", "よ〜！", "ね〜！", "！🙌", "！💪"],
  tone:    ["", " いつも応援してるよ！", " 一緒に頑張ろうね！", " またね！", " またすぐ来てね！",
            " 次もよろしくね！", " ファイトだよ！", " 楽しんでいってね！", " 応援してるよ！", " また話しかけてね！"],
  emoji:   ["", " 📖", " 🌟", " 💡", " 🎯", " 🔥", " 🚀", " 🌈", " ✨", " 💫"],
};

// /ask 質問未入力
// opening(12)×mood(12)×reaction(10)×nudge(10)×body(10)×hint(8)×bridge(10)×example(10)
// = 12×12×10×10×10×8×10×10 = 115,200,000通り
const _MSG_ASK_NOINPUT = {
  opening:  ["えっと、", "ん？", "あれ、", "むむ、", "待って、", "質問が…", "（質問がないよ！）", "あのー、",
             "おっと！", "うっ…", "ちょっと！", "んん？"],
  mood:     ["", "（なにを聞きたいの？）", "（空っぽだよ？）", "（えっ、書き忘れ？）",
             "（聞いてほしいことがあるのかな）", "（えっとえっと）", "（焦らないで！）",
             "（ゆっくりでいいよ！）", "（なんでも聞いてね！）", "（うれしい！でも空白だよ）",
             "（気になることあるのかな）", "（どんな疑問でもOKだよ）"],
  reaction: ["", " 質問がなかったよ？", " 何も書かれてないよ！", " テキストが空だよ〜",
             " 入力がなかったの！", " 書き忘れてないかな？", " 質問をくれないと答えられないの！",
             " 何かあったら書いてね！", " 聞きたいことがあるんじゃない？", " 気軽に書いてね！"],
  nudge:    ["", " ゆっくりでいいよ！", " 気軽にね！", " なんでもOKだよ！", " 遠慮しないで！",
             " 恥ずかしくないよ！", " どんな質問でも大歓迎！", " 思ったことを書いてね！",
             " 気になることがあれば！", " どうぞ〜！"],
  body:     ["質問を入力してほしいの！", "何を聞きたいか教えてほしいの！",
             "聞きたいことを書いてね！", "質問なしじゃわからないの！", "聞きたいことがあったら教えてね！",
             "質問を書いてくれると嬉しいな！", "何か聞きたいことある？書いてみて！",
             "思ってること何でも聞いていいよ！", "質問があれば教えてね！", "気になること、ある？"],
  hint:     ["\n", "\nなんでも聞いてOKだよ！ ", "\n気軽に質問してね！ ", "\nVibeちゃんが調べるよ！ ",
             "\nAIに何でも聞いちゃおう！ ", "\n答えるの大好きだよ！ ", "\n遠慮なく聞いてね！ ", "\nどんな疑問でも大歓迎！ "],
  bridge:   ["", " たとえば…", " こんなふうに→", " ヒント→", " こんな感じ：", " 使い方：",
             " フォーマット：", " 試してみて：", " 例えばこんな質問：", " 使用例："],
  example:  ["例: `/ask Claude Codeの便利な使い方は？`", "例: `/ask バイブコーディングって何？`",
             "例: `/ask MCPって何に使うの？`",           "例: `/ask AIエージェントの始め方は？`",
             "例: `/ask Cursorの使い方を教えて`",        "例: `/ask プロンプトエンジニアリングって？`",
             "例: `/ask Claudeと他のAIの違いは？`",      "例: `/ask VibeCodingで稼げる？`",
             "例: `/ask GitHub Copilotとの比較が知りたい`", "例: `/ask 今日のおすすめ技術記事は？`"],
};

// /ask Gemini未設定
// opening(10)×mood(10)×reaction(10)×body(12)×sympathy(10)×emoji(8)×request(12)
// = 10×10×10×12×10×8×12 = 115,200,000通り
const _MSG_ASK_NO_API = {
  opening:  ["ごめんね、", "うぅ、", "あのね、", "むむっ、", "ちょっと待って、", "えっとね、",
             "残念なんだけど、", "実はね、", "申し訳ないんだけど、", "今はね、"],
  mood:     ["", "（ぐすん）", "（頑張りたいのに…）", "（ごめんなさい）",
             "（うう…準備不足だった！）", "（次は使えるようにするね！）",
             "（管理者さんお願い…！）", "（いつか使えるようになるね！）",
             "（悔しいなぁ）", "（心苦しいの…）"],
  reaction: ["", " 実は、", " 残念ながら、", " 困ったことに、", " 正直に言うと、",
             " 申し訳ないんだけど、", " 悲しいことに、", " どうやら、",
             " 情けないことに、", " 白状すると、"],
  body:     ["AI機能がまだ設定されてないの…", "まだAIが使える状態じゃないの…", "Gemini APIキーが設定されてないみたい",
             "AI機能の準備がまだできてないの", "AIの設定が足りないみたい…", "今はAI機能が使えないの…",
             "Geminiとまだつながってないの", "AI機能がOFFになってるみたい", "APIキーがまだ設定されてないよ",
             "AIの準備が整ってないの", "Gemini APIが見当たらないの", "設定がまだ完了してないの…"],
  sympathy: ["", " ごめんね…", " 本当にごめんなさい", " 設定されたらすぐ動けるのに！",
             " 歯がゆいな…", " もどかしいよ〜", " 悔しいな…", " 早く使えるようになりたいな",
             " 準備が整ったら全力で答えるよ！", " きっとすぐ使えるようになるよ！"],
  emoji:    ["⚠️", "😿", "🔧", "💔", "🛠️", "😔", "🙏", "💭"],
  request:  ["管理者さんにGemini APIキーの設定をお願いしてね！", "管理者さんに設定してもらってね！",
             "管理者さんにAPIキーを設定してもらえると嬉しいな！", "管理者さんに頼んでみてね！",
             "管理者さんにお願いしてみて！", "設定してもらったらすぐ使えるよ！",
             "管理者さんにそっと伝えてみてね〜！", "環境変数GEMINI_API_KEYの設定をお願いします🙏",
             "管理者さん、APIキーよろしくです！", "設定完了したら全力で動くよ！",
             "準備できたら必ず頑張るから！", "APIキーさえあれば即戦力になれるのに！"],
};

// /ask 応答末尾
// opening(10)×mood(12)×powered(15)×bridge(10)×comment(10)×tone(8)×emoji(8)
// = 10×12×15×10×10×8×8 = 115,200,000通り (inside _..._)
const _MSG_ASK_POWERED = {
  opening:  ["", "ちなみに、", "今回は、", "今日は、", "さてさて、", "ふふ、", "えへ、", "あのね、", "ところで、", "実はね、"],
  mood:     ["", "（頑張ったよ！）", "（ドキドキしながら調べたよ！）", "（全力投球！）",
             "（わくわくしながら答えたよ！）", "（楽しかった！）", "（一生懸命調べたの！）",
             "（Geminiと息ぴったり！）", "（満足のいく回答ができたかな？）", "（ちょっと誇らしい！）",
             "（また聞いてほしいな！）", "（役立てたら嬉しいな！）"],
  powered:  ["Vibeちゃん × Geminiでお届け！", "Geminiが全力でサポートしてくれたよ！", "Vibeちゃんが調べたよ！",
             "AIの力で調査しました！", "Geminiと一緒にお答えしました！", "Vibeちゃん × AI の合作だよ！",
             "全力で調べてきたよ！", "Gemini先生に教えてもらったの！", "一緒に頑張ったよ！",
             "Geminiが教えてくれたよ！", "Vibeちゃん、全力投球でした！", "AIパワーで答えたよ！",
             "Geminiさんに助けてもらったの！", "最新AIで調べてみたよ！", "Vibeちゃん × Geminiチームで挑んだよ！"],
  bridge:   ["", " それでね、", " だから、", " ということで、", " まとめると、",
             " 参考までに、", " ちなみに、", " 付け加えると、", " ところで、", " そして、"],
  comment:  ["", "参考になったかな？", "お役に立てた？", "また聞いてね！",
             "どうだった？", "一緒に学んでいこうね！", "楽しんでね！", "次もよろしくね！",
             "何か疑問があればいつでも！", "もっと詳しく聞きたければ遠慮なく！"],
  tone:     ["", " 🤗", " 🌸", " ✌️", " 🙌", " 👍", " 💪", " 🫶"],
  emoji:    ["", " 💡", " ✨", " 🤖", " 🧠", " 🔍", " 🎯", " 🌟"],
};

// レート制限
// opening(12)×mood(12)×reaction(10)×body(10)×bridge(10)×emoji(8)×apology(10)×tail(10)
// = 12×12×10×10×10×8×10×10 = 115,200,000通り
const _MSG_RATE_LIMIT = {
  opening:  ["ちょっと待って〜！", "ごめんね〜！", "もう少し休ませて！", "あっぷあっぷ〜！",
             "うわっ、", "はわわ〜！", "ちょっとオーバーヒート中！", "息切れ中〜！",
             "ふーふー…！", "ひぃーっ！", "クールダウン中！", "ゼーハー…！"],
  mood:     ["", "（やばい疲れた）", "（もうギリギリ）", "（過負荷！）", "（休憩させてー！）",
             "（エネルギー切れ…）", "（全力疾走しすぎた）", "（ちょっとだけ待って）",
             "（次は答えるよ！）", "（本当ごめん）", "（回復中です…）", "（もう少しだから！）"],
  reaction: ["", " 疲れちゃったの…", " ちょっとギブ…", " 限界が来ちゃった！", " 休憩タイムなの〜！",
             " ちょっと詰まり気味かも", " フル稼働しすぎた！", " 一息つかせて〜",
             " ちょっとだけ時間ちょうだい", " すぐ戻るから待ってて！"],
  body:     ["1時間に30回まで使えるから、少し待ってね！", "ちょっとだけ時間をおいてね！",
             "1時間に30回が上限なの！", "少し休んだらまた答えるよ！",
             "ちょっと間隔を空けてみてね！", "連打しすぎてオーバーヒートしちゃった！",
             "しばらく後に試してみてね！", "レート制限に引っかかっちゃったの！",
             "毎時30回までなの、ごめんね！", "少し待ってから試してみて！"],
  bridge:   ["", " でも、", " とはいえ、", " だから、", " それでも、", " なので、",
             " ということで、", " まぁ、", " というわけで、", " だけど、"],
  emoji:    ["⏳", "💦", "😵", "🌀", "⚡", "🔥", "💤", "🛑"],
  apology:  ["", " ごめんね…", " 申し訳ないの", " 本当にごめん", " 悔しいな", " 歯がゆいよ",
             " もどかしいな", " 許してね", " 気をつけるよ", " 反省してる"],
  tail:     ["", " またすぐ使えるようになるよ！", " ちょっと休憩してね！", " すぐ戻ってくるね！",
             " 待っててね〜！", " 少しだけ待って！", " 頑張るから待ってて！", " ごめんね〜！",
             " 次は絶対答えるよ！", " すぐ復活するから！"],
};

// 未知コマンド
// opening(12)×mood(12)×reaction(12)×bridge(10)×body(10)×suggest(8)×apology(10)×emoji(8)
// = 12×12×12×10×10×8×10×8 = 110,592,000通り
const _MSG_UNKNOWN_CMD = {
  opening:  ["えっ？", "ん？", "（どれだろ…）", "あれ、", "むむ？", "わからないよ〜、", "うーん、", "ぽかん…",
             "はて？", "んんん？", "それは…", "うぅ？"],
  mood:     ["", "（知らない！）", "（そのコマンドは…）", "（えっ、何それ？）", "（どこで覚えたの？）",
             "（一応調べてみたけど）", "（うーんうーん）", "（存在しない気がするの）",
             "（初めて聞いたよ）", "（私も知りたい）", "（ちょっと戸惑ってる）", "（何のこと…？）"],
  reaction: ["", " そのコマンドは、", " それって、", " んー、そのコマンドだけど、", " ちょっと待って、",
             " 一応確認したんだけど、", " 記憶をたどってみたけど、", " 全力で考えてみたの、",
             " Vibeちゃんの知る限りでは、", " 正直に言うと、",
             " いろいろ調べてみたけど、", " 申し訳ないんだけど、"],
  bridge:   ["", " でも、", " だから、", " とはいえ、", " まぁ、",
             " それでね、", " だったりして、", " なんだよね〜", " みたいな感じ？", " というわけで、"],
  body:     ["そのコマンドは知らないの…", "そういうコマンドは持ってないの…", "それは使えないコマンドみたい…",
             "そのコマンドはないかも？", "ちょっとわからないの…", "そのコマンドがないよ…",
             "対応してないコマンドみたい", "そのコマンドは実装されてないの", "未知のコマンドだよ…",
             "そのコマンドには答えられないの"],
  suggest:  ["`/news` か `/ask` を使ってみてね！", "使えるのは `/news`, `/ask`, `/status` だよ！",
             "`/news` でニュース、`/ask` で質問してみてね！", "`/status` でステータスも確認できるよ！",
             "利用可能なコマンド: `/news` `/ask` `/status`", "試してみて！ → `/news`, `/ask <質問>`, `/status`",
             "`/ask` でなんでも聞いてみてね！", "/news や /ask を試してみて！"],
  apology:  ["", " ごめんね！", " 申し訳ないの！", " ごめんなさい！", " 悪いね！", " すまないね！",
             " 申し訳ないよ！", " ごめんよ！", " 覚えられなくてごめん！", " 教えてあげられなくてごめん！"],
  emoji:    ["❓", "🤔", "😕", "🙃", "💭", "🔮", "🫤", "🤷"],
};
...
function pickMsg(type) {
  if (type === "no_news") {
    return _r(_MSG_NO_NEWS.opening) + _r(_MSG_NO_NEWS.mood) + _r(_MSG_NO_NEWS.reaction)
         + _r(_MSG_NO_NEWS.nuance) + _r(_MSG_NO_NEWS.body) + _r(_MSG_NO_NEWS.connector)
         + _r(_MSG_NO_NEWS.emoji) + " " + _r(_MSG_NO_NEWS.tail);
  }
  if (type === "news_intro") {
    return _r(_MSG_NEWS_INTRO.opening) + _r(_MSG_NEWS_INTRO.mood) + _r(_MSG_NEWS_INTRO.vibe)
         + _r(_MSG_NEWS_INTRO.energy) + _r(_MSG_NEWS_INTRO.body) + _r(_MSG_NEWS_INTRO.hype)
         + _r(_MSG_NEWS_INTRO.exclaim);
  }
  if (type === "news_tail") {
    return `_${_r(_MSG_NEWS_TAIL.prefix)}${_r(_MSG_NEWS_TAIL.mood)}${_r(_MSG_NEWS_TAIL.body)}`
         + `${_r(_MSG_NEWS_TAIL.bridge)}${_r(_MSG_NEWS_TAIL.suffix)}${_r(_MSG_NEWS_TAIL.tone)}`
         + `${_r(_MSG_NEWS_TAIL.emoji)}_`;
  }
  if (type === "ask_noinput") {
    return _r(_MSG_ASK_NOINPUT.opening) + _r(_MSG_ASK_NOINPUT.mood) + _r(_MSG_ASK_NOINPUT.reaction)
         + _r(_MSG_ASK_NOINPUT.nudge) + _r(_MSG_ASK_NOINPUT.body)
         + _r(_MSG_ASK_NOINPUT.hint) + _r(_MSG_ASK_NOINPUT.bridge) + _r(_MSG_ASK_NOINPUT.example);
  }
  if (type === "ask_no_api") {
    return _r(_MSG_ASK_NO_API.opening) + _r(_MSG_ASK_NO_API.mood) + _r(_MSG_ASK_NO_API.reaction)
         + _r(_MSG_ASK_NO_API.body) + _r(_MSG_ASK_NO_API.sympathy) + "\n"
         + _r(_MSG_ASK_NO_API.emoji) + " " + _r(_MSG_ASK_NO_API.request);
  }
  if (type === "ask_powered") {
    return `_${_r(_MSG_ASK_POWERED.opening)}${_r(_MSG_ASK_POWERED.mood)}${_r(_MSG_ASK_POWERED.powered)}`
         + `${_r(_MSG_ASK_POWERED.bridge)}${_r(_MSG_ASK_POWERED.comment)}`
         + `${_r(_MSG_ASK_POWERED.tone)}${_r(_MSG_ASK_POWERED.emoji)}_`;
  }
  if (type === "rate_limit") {
    return _r(_MSG_RATE_LIMIT.opening) + _r(_MSG_RATE_LIMIT.mood) + _r(_MSG_RATE_LIMIT.reaction)
         + _r(_MSG_RATE_LIMIT.body) + _r(_MSG_RATE_LIMIT.bridge)
         + _r(_MSG_RATE_LIMIT.emoji) + _r(_MSG_RATE_LIMIT.apology) + _r(_MSG_RATE_LIMIT.tail);
  }
  // unknown_cmd
  return _r(_MSG_UNKNOWN_CMD.opening) + _r(_MSG_UNKNOWN_CMD.mood) + _r(_MSG_UNKNOWN_CMD.reaction)
       + _r(_MSG_UNKNOWN_CMD.bridge) + _r(_MSG_UNKNOWN_CMD.body) + " "
       + _r(_MSG_UNKNOWN_CMD.suggest) + _r(_MSG_UNKNOWN_CMD.apology) + " " + _r(_MSG_UNKNOWN_CMD.emoji);
}
